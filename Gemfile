=begin
  ...
  MVP
    models
      users
        admin
      talks
      posts (from user to talk)
        -- include join, leave, comment, broadcast
      maps
        -- with controls
      tweets
        -- prep for more general announcements

    database
      pure postgres
      use foreign keys & such
  ...
  MVP2
    ...
    docs
      rdoc as part of the project
      -- using Gemfile, models, & so on for project docs
